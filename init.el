...
(defvar my:ycmd-server-command '("python" "/home/ttt/emacsBackEnd/ycmd/ycmd"))

(defvar my:ycmd-extra-conf-whitelist '("/home/ttt/.ycm_extra_conf.py"))
(defvar my:ycmd-global-config "/home/ttt/.ycm_extra_conf.py")
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(powerline sourcerer-theme yasnippet-snippets yasnippet hungry-delete vlf multiple-cursors company-jedi flycheck-ycmd company-ycmd ycmd google-c-style modern-cpp-font-lock realgud zzz-to-char avy which-key beacon rainbow-delimiters origami wgrep counsel-etags counsel swiper ivy auto-package-update s use-package)))
